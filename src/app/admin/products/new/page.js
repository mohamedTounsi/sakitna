...
function ImageUploadBox({ label, hint, accept, multiple, onFiles, previews, onRemove }) {
  ...
  return (
    <div>
      ...
      <label
        ...
        onDrop={handleDrop}
        className={`flex flex-col items-center justify-center gap-3 border border-dashed p-8 cursor-pointer transition-all duration-200 ${
          dragging
      ...
      >
        ...
        <div className="text-center">
          <p className="text-[10px] font-bold uppercase tracking-[0.2em] text-slate-400">
            Drop image{multiple ? 's' : ''} or{' '}
            <span className="text-white">browse</span>
          </p>
          <p className="text-[9px] font-bold uppercase tracking-widest text-slate-600 mt-1">PNG · JPG · WEBP · Max 10MB</p>
        </div>
      </label>
...
export default function NewProduct() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const [frontUrl, backUrl, ...galleryUrls] = await Promise.all([
        frontFile ? uploadToCloudinary(frontFile) : Promise.resolve(''),
        backFile ? uploadToCloudinary(backFile) : Promise.resolve(''),
        ...
        <div className="bg-[#07101f] border border-white/8 overflow-hidden">
          ...
          <div className="p-7 space-y-8">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
              <ImageUploadBox
                label="Front Image"
                hint="Primary product photo (front of t-shirt)"
              ...
              <ImageUploadBox
                label="Back Image"
                hint="Back of t-shirt — shown on hover"
            ...
            <ImageUploadBox
              ...
              hint="Additional photos shown in the product detail page (select multiple)"
              multiple
